...
export function TemplateForm({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast.success(mode === "create" ? "Template salvo com sucesso!" : "Template atualizado com sucesso!")
    } catch (_error) {
      toast.error(mode === "create" ? "Erro ao salvar template." : "Erro ao atualizar template.")
    } finally {
      setIsSaving(false)
    }
  }
