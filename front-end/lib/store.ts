...
export const variaveisDisponiveis: Variavel[] = [
  { id: '1', nome: 'nome', label: 'Nome completo', tipo: 'texto' },
  { id: '2', nome: 'cpf', label: 'CPF do beneficiário', tipo: 'texto' },
  { id: '3', nome: 'rg', label: 'RG do beneficiário', tipo: 'texto' },
  { id: '4', nome: 'data_nascimento', label: 'Data de nascimento', tipo: 'data' },
  { id: '5', nome: 'endereco', label: 'Endereço completo', tipo: 'texto' },
  { id: '6', nome: 'cidade', label: 'Cidade', tipo: 'texto' },
  { id: '7', nome: 'estado', label: 'Estado', tipo: 'texto' },
  { id: '8', nome: 'cep', label: 'CEP', tipo: 'texto' },
  { id: '9', nome: 'telefone', label: 'Telefone', tipo: 'texto' },
  { id: '10', nome: 'email', label: 'E-mail', tipo: 'texto' },
  { id: '11', nome: 'data_atual', label: 'Data atual', tipo: 'data' },
  { id: '12', nome: 'numero_documento', label: 'Número do documento', tipo: 'texto' },
]
...
<p style="text-align: center;">_________________________________<br/>Assinatura</p>`,
  ...
  {
    id: '2',
    nome: 'Comprovante de Atendimento',
...
<p style="text-align: center;">_________________________________<br/>Responsável pelo Atendimento</p>`,
  ...
  {
    id: '3',
    nome: 'Autorização de Uso de Dados',
...
<p style="text-align: justify;">Estou ciente de que meus dados serão tratados de acordo com a Lei Geral de Protection de Dados (LGPD - Lei nº 13.709/2018).</p>
<p style="text-align: right;">{{cidade}}, {{data_atual}}</p>
<br/><br/>
