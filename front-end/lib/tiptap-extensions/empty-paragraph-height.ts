...
function mergeEmptyParagraphStyle(
...
function stripEmptyParagraphStyle(
            ...
            new Plugin({
                appendTransaction: (transactions, _oldState, newState) => {
                    ...
                    newState.doc.descendants((node, pos) => {
                        ...
                        const currentStyle = node.attrs.style as
                            | string
                            | null
                            | undefined;
                        ...
                        if (node.content.size === 0) {
                            const nextStyle =
                                mergeEmptyParagraphStyle(currentStyle);
                        ...
                        if (hasEmptyParagraphStyle(currentStyle)) {
                            const nextStyle =
                                stripEmptyParagraphStyle(currentStyle);
                            if (nextStyle !== currentStyle) {
                                tr.setNodeMarkup(pos, undefined, {
                                    ...node.attrs,
                                    style: nextStyle,
